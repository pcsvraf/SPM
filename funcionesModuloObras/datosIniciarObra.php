...
$query = "
 ...
 ";
if ($nombreCompleto != "Juan Pavez" and $nombreCompleto != "Danka Roco" and $nombreCompleto != "Vania Jara" and $nombreCompleto != "Camila Tapia Zamora"){
  $query .= " WHERE obraNueva.email='$correo' &&";
}else{
  $query .= "WHERE";
}
