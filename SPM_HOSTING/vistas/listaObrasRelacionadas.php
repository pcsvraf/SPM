...
<html>
    ...
    <body>
    <center>
        <h1>Ejecutar acciones en las Obras Adicionales</h1>
    </center>
    <br>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetch_data(is_category)
            {
                $('#tabla').DataTable({
                    ...
                    "ordering": false,
                    "ajax": {
                        url: "../funcionesModuloObras/datosListaObraRelacionada.php",
                        type: "POST",
        ...
        $(document).on('click', '.eliminar', function () {
            ...
            if (x) {
                window.location = "../funcionesModuloObras/eliminarRelacionada.php?id=" + id;
            }
        });
