...
$destino = "../archivosObraRelacionada/" . $nombreArchivo;
...
if (move_uploaded_file($ruta, $destino)) {
    $query = "INSERT INTO obraRelacionada(id, monto, numeroRelacionObra, contratista, observaciones, rutContratista, fecha, nombreArchivo, nombreRandom, estado, nombreEstado, encargadoObra)
          VALUES('$ide','$monto','$idObra','$contratista','$observaciones','$rutContratista','$dia-$mes-$anio','$nombreArchivo','$realName','1','Obra Ingresada','$nombreApellido')";
