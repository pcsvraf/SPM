...
while ($row = mysqli_fetch_array($result)) {
    ...
    if($row["nombreEstado"]==="Obra Finalizada"){
      ...
      $sub_array[] = '<button type="button" name="finalizada" class="btn btn-info btn-xs finalizada" value="' . $row["id"] . '" disabled>Ver Obra Finalizada</button>';
